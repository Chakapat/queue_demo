...
<head>
	...
	<title>Vaccien Department Page</title>
	...
	<div class="container">
		<div class="row h-100 justify-content-center align-items-center">
			<div class="col-10 col-md-8 col-lg-6">
				...
				<br><h4 class="text-center mb-4">Vaccien Department Page</h3>

				<form name="users" method="post" action="vaccien_department_code.php" class="form-example" enctype="multipart/form-data">
            ...
            <div class="group">
                <input required="" type="text" class="input" name="user_detail">
                <span class="highlight"></span>
                <span class="bar"></span>
            ...
            <div class="custom-select" style="width:100%;">
                <select name="user_vaccien" id="user_vaccien" required>
                <option value="v0">โปรดเลือกวัคซีน</option>
          ...
          <br><div class="container-calendar">
          ...
          <div class="group">
            <input type="hidden" class="input" name="department" value="แผนกวัคซีน">
          </div>
          ...
          <button style="width:49%"  class="btn-reset" type="reset">ล้างข้อมูล</button>
				...
				<form action="vaccine_department_showqueue.php?user_idcard=user_idcard" method="get">
